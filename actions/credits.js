...
const PLAN_CREDITS = {
  ...
  advanced: 10, // Standard plan: 10 credits per month
  elite: 24, // Premium plan: 24 credits per month
};
...
export async function checkAndAllocateCredits(user) {
  try {
    ...
    const hasadvanced = has({ plan: "advanced" });
    const hasElite = has({ plan: "elite" });
