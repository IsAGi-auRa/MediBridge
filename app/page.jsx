      ...
      <div className="container mx-auto px-4 ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            text-sm font-medium"
            >Your Health, Just a Click Away</Badge>
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-md">
              Appointments, Video Consults, and Care—All Together.
            </p>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Bringing healthcare to your fingertips, effortlessly
          </p>
        </div>
    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Stories from patients and doctors on our platform
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Thousands of users trust us to make healthcare simple, fast, and accessible. Start your journey today!
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    asChild
